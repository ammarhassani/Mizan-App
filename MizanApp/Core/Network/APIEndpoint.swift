...
struct MethodParams: Codable {
    let fajr: FlexibleNumber?
    let isha: FlexibleNumber?
    let maghrib: String?
    let midnight: String?
...
/// Handles API values that can be either Double or String (e.g., "90 min")
